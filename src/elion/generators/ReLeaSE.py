...
from elion.utils import print_results,save_smi_file
from .AbstractGenerator import AbstractGenerator
from .release.release_generator import release_smiles_generator, print_torch_info
    ...
    def bias_generator(self, ctrl_opts, estimator):
        ...
        with warnings.catch_warnings():
            ...
            for reinforcement_iteration in range(gen_start, gen_start + max_iterations):
                ...
                # Dump history
                with open("biasing_history.csv",'a', encoding='utf-8') as f:
                ...
                if (reinforcement_iteration % 2) == 0:
                    ...
                    save_smi_file(smi_path, smis, predictions)
