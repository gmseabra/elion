...
#       GMS: Allow for isomeric SMILES (with stereochemistry. Also, guarantee canonicalization.)
#        yield (Chem.MolToSmiles(mol, isomericSmiles=False), input_mol_representation)
        yield (Chem.MolToSmiles(mol, isomericSmiles=True, canonical=True), input_mol_representation)
