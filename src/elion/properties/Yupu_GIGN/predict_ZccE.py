...
from dataset_GIGN_ZccE import GraphDataset, PLIDataLoader
import numpy as np
from utils import *
...
# ZccE
from rdkit import Chem
ligand = Chem.MolFromPDBFile('/home/huangzihang/repos/Yupu_GIGN/data/toy_set/ZccE/ZccE_ligand.pdb', removeHs=True)
pocket = Chem.MolFromPDBFile('/home/huangzihang/repos/Yupu_GIGN/data/toy_set/ZccE/ZccE_protein.pdb', removeHs=True)
complex = (ligand, pocket)
with open('/home/huangzihang/repos/Yupu_GIGN/data/toy_set/ZccE/ZccE_5A.rdkit', 'wb') as f:
    pickle.dump(complex, f)
