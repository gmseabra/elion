...
if __name__ == '__main__':
    ...
    for repeat in range(repeats):
        ...
        logger = TrainLogger(args,'finetuning', cfg, create=True)
        ...
        train_set.graph_paths = all_path[:-1000]
        ...
        # model = model.module
        # model.load_state_dict(torch.load("/blue/zhe.jiang/y.zhang1/GIGN/model/20240522_212610_GIGN_repeat0/model/epoch-6, train_loss-4.0083, train_rmse-2.0021, valid_rmse-4.5241, valid_pr-1.0000.pt"))
        # model.load_state_dict(torch.load("/blue/zhe.jiang/y.zhang1/GIGN/model/20240607_021922_GIGN_repeat0_preinfonce/model/epoch-82, train_loss-9.1423, train_rmse-3.0236, valid_rmse-1.2519, valid_pr-1.0000.pt"))
        # model.load_state_dict(torch.load("/blue/zhe.jiang/y.zhang1/GIGN/model/20240628_222727_GIGN_repeat0_pretrain_de/model/epoch-10, train_loss-2.4106, train_rmse-1.5526, valid_rmse-4.5900, valid_pr-1.0000.pt"))
        # model.load_state_dict(torch.load("/blue/zhe.jiang/y.zhang1/GIGN/model/20240602_225702_GIGN_repeat0_preinfonce/model/epoch-56, train_loss-15.5255, train_rmse-3.9402, valid_rmse-13.1822, valid_pr-1.0000.pt"))
        model.load_state_dict(torch.load("/blue/zhe.jiang/y.zhang1/GIGN/model/20240708_142147_GIGN_repeat8_pretrain_de/model/epoch-19, train_loss-4.4989, train_rmse-2.1211, valid_rmse-7.3875, valid_pr-1.0000.pt"))
        ...
        for epoch in range(epochs):
            ...
            # start validating
            valid_rmse, valid_pr = val(model, test2016_loader, device)
