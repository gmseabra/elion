...
# Define paths
input_csv = "/blue/lic/huangzihang/repos/elion/src/RL_feedback_loop/results_TS/LGBM_suzuki_TS_3.csv"
output_dir = "/blue/lic/huangzihang/repos/elion/src/vina/LGBM_suzuki/3/pdb"
