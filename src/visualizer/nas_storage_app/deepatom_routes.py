...
#
# Extracted from nas_storage_app/routes.py.
...
DEEPATOM_SCRIPT = (
    "/home/huangzihang/repos/deepatom/bin/"
    "predict_binding_affinity_v4_2_data_split_ZccE_elion.sh"
)
DEEPATOM_DEFAULT_DATA_DIR = (
    "/blue/lic/huangzihang/repos/elion/src/elion/properties/deepatom/data/ZccE"
)
DEEPATOM_DEFAULT_TEST_TYPE = "vs"
