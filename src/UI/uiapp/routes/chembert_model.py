...
def _keyword_route_attn(user_message: str) -> dict | None:
    ...
    """
    try:
        from uiapp.router.ui_action_router import route_ui_action as _rag_route
...
def _load_chembert(model_path: str):
    ...
    """
    from uiapp.CHEMBERT.model   import Smiles_BERT, BERT_base
    from uiapp.CHEMBERT.chembert import Vocab
...
class AdjacencyWeightVisualizer:
    ...
    def predict_score(self, smiles):
        ...
        from uiapp.CHEMBERT.chembert import SMILES_Dataset, Vocab
...
DEFAULT_FINETUNED   = str(_ROOT / "Elion-AGI-Ecosystem" / "attention_visualization" /
                          "uiapp" / "CHEMBERT" / "Finetuned_model_5.pt")
DEFAULT_PRETRAINED  = str(_ROOT / "Elion-AGI-Ecosystem" / "attention_visualization" /
                          "uiapp" / "CHEMBERT" / "pretrained_model.pt")

CHEMBERT_BASE = "uiapp.CHEMBERT"   # import root for chembert modules
