...
# ── Paths ─────────────────────────────────────────────────────────────────────
# Centralised in uiapp.config (see there for env-var overrides).
from uiapp import config as _cfg

_BASE        = os.path.dirname(os.path.abspath(__file__))
KB_DIR       = _cfg.UI_ACTION_KB_DIR
INDEX_PATH   = _cfg.UI_ACTION_INDEX
DOCS_PATH    = INDEX_PATH + ".json"
ENCODER_PATH = _cfg.ENCODER_PATH   # override with UI_ENCODER_PATH
...
def route_ui_action(user_message: str,
    ...
    Usage in routes.py:
        from uiapp.router.ui_action_router import route_ui_action
        ...
