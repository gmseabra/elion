...
# ── Paths ─────────────────────────────────────────────────────────────────────
# DeepAtom is an external project. Its root defaults to the sibling location
# but can be overridden with the DEEPATOM_ROOT environment variable.
_DEEPATOM_ROOT = Path(
    os.environ.get("DEEPATOM_ROOT")
    or (config.REPO_ROOT.parent / "elion" / "src" / "elion" / "properties" / "deepatom")
)
